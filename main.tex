...
\begin{document}
	...
	\include{section2}
	\include{section3}
	\include{section4_lab1}
	\include{section5_lab2}
	\include{section6_lab3}
	\include{section7_lab4}
	\include{section8_lab5}
	\include{section9_lab6}
    \include{conclusion}
    \addbibliography{Список используемой литературы}
    \include{lastPage}
    \include{backPage}
